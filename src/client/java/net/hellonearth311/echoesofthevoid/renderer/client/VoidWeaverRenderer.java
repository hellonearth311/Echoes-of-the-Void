...
public class VoidWeaverRenderer extends LivingEntityRenderer<VoidWeaverEntity, LivingEntityRenderState, SpiderEntityModel> {
    private static final Identifier TEXTURE = Identifier.of("echoesofthevoid", "textures/entity/void_weaver.png");

    public VoidWeaverRenderer(EntityRendererFactory.Context ctx) {
