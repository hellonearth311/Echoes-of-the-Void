...
public class ElderShadeEntity extends SkeletonEntity {

    public ElderShadeEntity(EntityType<? extends ElderShadeEntity> entityType, World world) {
    ...
    @Override
    public boolean isFireImmune() { return false; }
